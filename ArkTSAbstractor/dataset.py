...
if __name__ == '__main__':
    root_folder = '/Users/liuxuejin/Desktop/Projects/HMDataAugmentation/ArkTSAbstractor/output_data'
    ui_code_output_file = './dataset_ui_code.json'
    functions_output_file = './dataset_functions.json'
