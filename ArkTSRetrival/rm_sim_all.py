...
def process_json_files(folder_path):
    ...
    # Read all JSON files and collect data
    ...
    unique_data = remove_similar_strings(all_data)
    
    # Write the modified data back to a single file
    output_folder = os.path.join(folder_path, 'out')
    os.makedirs(output_folder, exist_ok=True)
    output_file = os.path.join(output_folder, 'combined_unique_data.json')
